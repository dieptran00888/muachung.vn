...
//            echo "<h3>$row[masp]</h3>";
                        ...
                        echo "<a href='delcart.php?productid=$row[id]'>Xoa San Pham Nay</a></p>";
                        echo "<p align='right'> Gia tien cho mon hang: ". number_format($_SESSION['cart'][$row['id']]*$row['gia'],0) ." VNĐ</p>";
                        echo "</div>";
